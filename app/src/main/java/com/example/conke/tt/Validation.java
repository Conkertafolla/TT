...
public class Validation {
    ...
    private static final String EMAIL_MSG = "formato de e-mail incorrecto";
    private static final String PHONE_MSG = "campo numerico";
    private static final String TEXT_MSG = "campo solo alfabetico";
    private static final String DATE_MSG = "Formato de Fecha incorrecto";
